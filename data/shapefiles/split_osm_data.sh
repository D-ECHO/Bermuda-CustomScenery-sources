...
#	LANDUSE
ogr2ogr -f "ESRI Shapefile"  -where "landuse = 'commercial' OR landuse = 'retail'" osm_commercial/osm_commercial.shp bermuda_polygons.shp
...
ogr2ogr -f "ESRI Shapefile"  -where "landuse = 'plant_nursery'" osm_plantnursery/osm_plantnursery.shp bermuda_polygons.shp
...
ogr2ogr -f "ESRI Shapefile"  -where "landuse = 'grass' OR landuse = 'flowerbed'" osm_grass/osm_grass.shp bermuda_polygons.shp
...
ogr2ogr -f "ESRI Shapefile"  -where "landuse = 'brownfield'" osm_brownfield/osm_brownfield.shp bermuda_polygons.shp

#	LEISURE
ogr2ogr -f "ESRI Shapefile"  -where "leisure = 'track'" osm_grass/osm_track.shp bermuda_polygons.shp
#ogr2ogr -f "ESRI Shapefile"  -where "leisure = 'swimming_pool'" osm_lake/osm_swimming_pool.shp bermuda_polygons.shp	disabled to reduce complexity
#ogr2ogr -f "ESRI Shapefile"  -where "leisure = 'playground'" osm_grass/osm_playground.shp bermuda_polygons.shp		disabled to reduce complexity
#ogr2ogr -f "ESRI Shapefile"  -where "leisure = 'pitch'" osm_grass/osm_pitch.shp bermuda_polygons.shp			disabled to reduce complexity
...
ogr2ogr -f "ESRI Shapefile"  -where "leisure = 'beach_resort'" osm_golfcourse/osm_beach_resort.shp bermuda_polygons.shp

#	MAN MADE
ogr2ogr -f "ESRI Shapefile"  -where "man_made = 'pier'" osm_port/osm_pier.shp bermuda_polygons.shp

#	NATURAL
ogr2ogr -f "ESRI Shapefile"  -where "natural = 'wood'" osm_forest/osm_wood.shp bermuda_polygons.shp
ogr2ogr -f "ESRI Shapefile"  -where "natural = 'wetland'" osm_wetland/osm_wetland.shp bermuda_polygons.shp
...
ogr2ogr -f "ESRI Shapefile"  -where "natural = 'bare_rock' OR natural = 'cliff' OR natural = 'rock'" osm_rock/osm_barerock.shp bermuda_polygons.shp
