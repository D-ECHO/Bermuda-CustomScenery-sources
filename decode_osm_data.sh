ogr-decode --max-segment 500 --line-width 12 --area-type Highway work/Asphalt data/shapefiles/osm_motorway/
ogr-decode --max-segment 500 --line-width 10 --area-type Highway work/Asphalt data/shapefiles/osm_trunk/
ogr-decode --max-segment 500 --line-width 8 --area-type Road work/Asphalt data/shapefiles/osm_primary/
ogr-decode --max-segment 500 --line-width 6.5 --area-type Road work/Asphalt data/shapefiles/osm_secondary/
ogr-decode --max-segment 500 --line-width 5 --area-type Road work/Asphalt data/shapefiles/osm_tertiary/
...
ogr-decode --max-segment 500 --area-type Heath work/Heath data/shapefiles/osm_heath/
ogr-decode --max-segment 500 --area-type BarrenCover work/BarrenCover data/shapefiles/osm_scree/
ogr-decode --max-segment 500 --area-type Ocean work/Ocean data/shapefiles/osm_shoal/
...
ogr-decode --max-segment 500 --area-type Cemetery work/Cemetery data/shapefiles/osm_cemetery/
